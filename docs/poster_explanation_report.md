...
여기서 R은 음식점 1,000개당 행정처분 발생률 백분위, T는 최근 3개월 대비 행정처분 발생률 증가추세 백분위, E는 소비자물가 압박 백분위, H는 최근 3개월 반복 핫스팟 점수다. 점수는 0~100점으로 산출하며, 80점 이상은 최우선 현장점검 검토, 60~79점은 우선점검 후보, 40~59점은 추세 모니터링, 40점 미만은 정기점검 유지 대상으로 해석하였다. 가중치 민감도 분석에서는 발생률 중심안과 균형안을 비교했을 때 기본안 대비 상위 10개 점검 후보 중 8~9개가 유지되어 운영지수의 순위 안정성을 확인하였다.
